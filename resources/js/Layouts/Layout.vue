<template>
  <div class="flex">
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">JOCEBELLE GUERUELA</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-9 w-9" src="https://i.pinimg.com/564x/9f/e8/ae/9fe8ae4f932c8eb82a351bf20ab0935c.jpg" alt="avatar">
                <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Jocebelle Gueruela</h4>
            </div>
        </div>
    </div>
      ...
      <div class="w-full flex flex-col">main</div>
        <div class="w-full">
